...
### [`job-search-pipeline`](https://github.com/dome317/job-search-pipeline)
...
<br/><sub>Python | SQLite | Docker | Claude API | Playwright</sub>

</td></tr>
<tr><td>

### [`ai-social-engine`](https://github.com/dome317/ai-social-engine)
...
<br/><sub>TypeScript | Node.js | LangGraph | LiteLLM | PostgreSQL | Redis | Docker</sub>

</td></tr>
<tr><td>

### [`spec-to-proposal-router`](https://github.com/dome317/spec-to-proposal-router)
...
<br/><sub>Python | Streamlit | Claude API | OpenAI API</sub>

</td></tr>
<tr><td>

### [`doc-ai-assistant`](https://github.com/dome317/doc-ai-assistant)
...
<br/><sub>Python | Streamlit | Claude API | RAG | PDF Parsing</sub>

</td></tr>
<tr><td>

### [`growth-quiz-engine`](https://github.com/dome317/growth-quiz-engine)
...
<br/><sub>React 19 | TypeScript | Vite | Tailwind | Framer Motion</sub>

</td></tr>
<tr><td>

### [`lead-intelligence-bot`](https://github.com/dome317/lead-intelligence-bot)
...
<br/><sub>Next.js | Claude API | Make.com | HubSpot | Slack API</sub>

</td></tr>
<tr><td>

### [`autonomous-sales-swarm`](https://github.com/dome317/autonomous-sales-swarm)
...
<br/><sub>n8n | Claude API | Supabase | pgvector | HubSpot | Docker</sub>
